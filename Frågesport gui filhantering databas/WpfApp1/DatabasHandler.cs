...
namespace WpfDemoTowerSql
{
    class DatabaseHandler
    {
        ...
        private string dbName = "qnadata.db";
        ...
        public void InitializeDatabase()
        {
               ...
               new SqliteConnection($"Filename={GetPathAndDbName()}"))
            {
                ...
                String tableCommand = "CREATE TABLE IF NOT " +
                    "EXISTS fraga (id INTEGER PRIMARY KEY AUTOINCREMENT ," +
                    "fragan VARCHAR(128) NOT NULL," +
                    "svaret VARCHAR(128));";
        ...
        public void AddQuestions(string question, string answer)
        {
              ...
              new SqliteConnection($"Filename={GetPathAndDbName()}"))
            {
                ...
                insertCommand.CommandText = "INSERT INTO fraga (fragan, svaret) VALUES (@question, @answer);";
        ...
        /// </summary>
        /// <param name="tower"></param>
        public void DeleteQuestion(Tower fraga)
        {
            using (SqliteConnection db =
              new SqliteConnection($"Filename={GetPathAndDbName()}"))
            {
                ...
                // Use parameterized query to prevent SQL injection attacks
                sqlCommand.CommandText = "DELETE FROM fraga WHERE id=@id";

                sqlCommand.Parameters.AddWithValue("@id", fraga.Id);
        ...
        {
            AddTower("Burj Khalifa", hej);
            AddTower("Shanghai Tower", tjena);
            AddTower("Abraj Al-Bait Clock Tower", wow);
        ...
        private int NumberOfQuestions()
        {
              ...
              new SqliteConnection($"Filename={GetPathAndDbName()}"))
            {
                ...
                sqlCommand.CommandText = "SELECT COUNT (id) FROM fraga";
